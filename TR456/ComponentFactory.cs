...
internal class ComponentFactory : IComponentFactory
{
    ...
    /// <inheritdoc />
    /// <remarks>
    ///     Using <see cref="ComponentCategory.Timer" /> makes the component appear in the <c>Timer</c> section of the <c>+</c>
    ///     menu in LiveSplit's Layout Editor.
    /// </remarks>
    public ComponentCategory Category => ComponentCategory.Timer;

    /// <inheritdoc />
    /// <remarks>This is the text you see in the menu which you see after pressing + in the Layout Editor.</remarks>
    public string ComponentName => "Tomb Raider IV-VI Remastered";

    /// <inheritdoc />
    /// <remarks>
    ///     This is the text that appears when you hover over the component in the <c>+</c> menu in LiveSplit's Layout Editor.
    /// </remarks>
    public string Description => "Autosplitter for Tomb Raider IV-VI Remastered";

    /// <inheritdoc />
    /// <param name="state">State passed by LiveSplit</param>
    /// <remarks>This loads the component's code into LiveSplit.</remarks>
    ...
    /// <summary>Name used for component updates.</summary>
    /// <remarks>This can be the same as <see cref="IComponentFactory.ComponentName" />.</remarks>
    ...
    /// </remarks>
    public string XMLURL => Path.Combine(UpdateURL, "TR456/Components/update.xml");
