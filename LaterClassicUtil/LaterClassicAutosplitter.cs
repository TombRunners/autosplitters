    ...
    where TSettings : LaterClassicComponentSettings
{
    ...
    public override TimeSpan? GetGameTime(LiveSplitState state)
    {
        ...
        return TimeSpan.FromSeconds(BaseOgGameData.LevelTimeAsDouble(Data.GameTimer.Current - _ticksAtStartOfRun));
    }
    ...
    public override bool ShouldReset(LiveSplitState state)
    {
        ...
        // This works because when loading non-test/demo versions of the games, level initializes as 0 before the main menu load is called.
