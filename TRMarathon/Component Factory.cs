...
[assembly: ComponentFactory(typeof(TRMarathon.ComponentFactory))]
...
namespace TRMarathon
{
    ...
    internal sealed class ComponentFactory : IComponentFactory
    {
        ...
        /// </remarks>
        public string ComponentName => "Tomb Raider Marathon";

        /// <inheritdoc/>
        /// <remarks>
        ///     This is the text that appears when you hover over the component in the <c>+</c> menu in LiveSplit's Layout Editor.
        /// </remarks>
        public string Description => "Autosplitter for Tomb Raider Marathons";
        ...
        /// </remarks>
        public IComponent Create(LiveSplitState state) => new TRMarathon.Component(new TRMarathon.Autosplitter(), state);
        ...
        /// </remarks>
        public string XMLURL => UpdateURL + "TRMarathon/Components/update.xml";
